                                ...
                                <div class="basic-form">
                                    <form id="saveForm">
                                               ...
                                               <input type="hidden" name="url" value="${data.url }" >
                                                 ...
                                                 <div class="mb-3">
                                                <label class="form-label">教学资料主题</label>
                                                <input type="text" name="title" value="${data.title }" class="form-control" >
                                            </div>
                                            
                                              <div class="mb-3">
                                                <label class="form-label">教学资料内容</label>
                                          ...
                                          <div class="mb-3">
                                           ...
                                           <a href="MaterialServlet?action=MaterialList" class="btn btn-info   mt-3">返回</a>
	...
	$("#save").click(function() {
		//swal("删除失败", "", "success")
		 $.ajax({
			cache:true,
			type : "post",
			url : "MaterialServlet?action=updateMaterial",
			data : $("#saveForm").serialize(),
			async:false,
			success : function(e) {
				if (e == "yes") {
					alert("修改成功！");
					window.location.href = "MaterialServlet?action=MaterialList";
				}else{
					alert("修改失败");
				}
			}
