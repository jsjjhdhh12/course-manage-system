                                ...
                                <div class="basic-form">
                                    <form id="saveForm">
                                          ...
                                          <div class="mb-3">
                                                ...
                                                <input type="text" name="editor" value="${data.editor }" class="form-control" >
                                            </div>
                                            <button type="button" id="save" class="btn btn-primary mt-3">提交</button>
                                             <a href="BoardServlet?action=BoardList" class="btn btn-info   mt-3">返回</a>
                                    </form>
		...
		//swal("删除失败", "", "success")
		 $.ajax({
			...
			success : function(e) {
				if (e == "yes") {
					alert("修改成功！");
					window.location.href = "BoardServlet?action=BoardList";
				}else{
					alert("修改失败");
				}
			}
