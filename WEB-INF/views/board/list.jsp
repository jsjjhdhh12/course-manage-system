					...
					<div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">公告信息列表</h4>
                            </div>
                                <div class="card-header">
                                    <form action="BoardServlet?action=BoardList"  method="post"  class="d-flex align-items-center">
                                        <div class="mb-2 mx-sm-3">
                                            <input type="text" name="key" value="${key }" class="form-control" placeholder="公告标题">
                                        </div>
                                    ...
                                    <table class="table table-bordered table-responsive-md" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
													<div class="d-flex">
														<a href="BoardServlet?action=toUpdateBoard&id=${data.id }" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
