					...
					<div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">学生信息列表</h4>
                            </div>
                                <div class="card-header">
                                    <form action="StudentServlet?action=StudentList"  method="post"  class="d-flex align-items-center">
                                    ...
                                    <table class="table table-bordered table-responsive-md" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
													<div class="d-flex">
														<a href="StudentServlet?action=toUpdateStudent&id=${data.id }" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
    ...
    function del(id){
    	if(confirm("确定要删除吗？")){
    		$.ajax({
    			cache:true,
    			type : "post",
    			url : "StudentServlet?action=deleteStudent",
    			 data :{"id":id},
    			async:false,
    			success : function(e) {
    				if (e == "yes") {
