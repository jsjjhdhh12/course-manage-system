                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form id="saveForm">
                                            ...
                                            <div class="mb-3">
                                              ...
                                              <div class="mb-3">
                                                ...
                                                <input type="text" name="eno" value="${data.eno }" class="form-control"  readonly>
                                            </div>
                                            
                                              <div class="mb-3">
                                                <label class="form-label">密码</label>
                                                <input type="password" name="pwd" value="${data.pwd }" class="form-control" >
                                            </div>
                                               
		                                         <div class="mb-3">
		                                            <label class="form-label">性别:</label>
		                                            <select class="default-select  form-control wide" name="sex" >
		                                                <option value="男" <c:if test="${data.sex == '男' }"></c:if> >男</option>
		                                                <option value="女" <c:if test="${data.sex == '女' }"></c:if> >女</option>
		                                            </select>
		                                        </div> 
                                              <div class="mb-3">
                                    ...
                                    <a href="StudentServlet?action=StudentList" class="btn btn-info   mt-3">返回</a>
		...
		//swal("删除失败", "", "success")
		 $.ajax({
			...
			success : function(e) {
				if (e == "yes") {
					alert("修改成功！");
					window.location.href = "StudentServlet?action=StudentList";
				}else{
					alert("修改失败");
				}
			}
