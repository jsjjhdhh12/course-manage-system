					...
					<div class="col-xl-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <a href="MessageServlet?action=MessageList" class="btn btn-info   mt-3">返回</a>
	...
	$("#save").click(function() {
		//swal("删除失败", "", "success")
		 $.ajax({
			cache:true,
			type : "post",
			url : "MessageServlet?action=updateMessage",
			data : $("#saveForm").serialize(),
			async:false,
			success : function(e) {
				if (e == "yes") {
					alert("修改成功！");
					window.location.href = "MessageServlet?action=MessageList";
				}else{
					alert("修改失败");
				}
			}
