					...
					<div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">教师信息列表</h4>
                            </div>
                                <div class="card-header">
                                    <form action="TeacherServlet?action=TeacherList"  method="post"  class="d-flex align-items-center">
                                        <div class="mb-2 mx-sm-3">
                                            <input type="text" name="key" value="${key }" class="form-control" placeholder="姓名">
                                        </div>
                                    ...
                                    <table class="table table-bordered table-responsive-md" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
													<div class="d-flex">
														<a href="TeacherServlet?action=toUpdateTeacher&id=${data.id }" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
    ...
    function del(id){
    	if(confirm("确定要删除吗？")){
    		$.ajax({
    			cache:true,
    			type : "post",
    			url : "TeacherServlet?action=deleteTeacher",
    			 data :{"id":id},
    			async:false,
    			success : function(e) {
    				if (e == "yes") {
