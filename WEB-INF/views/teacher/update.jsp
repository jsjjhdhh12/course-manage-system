                                    ...
                                    <form id="saveForm">
                                            ...
                                            <div class="mb-3">
                                              ...
                                              <div class="mb-3">
                                                ...
                                                <input type="text" name="tno" value="${data.tno }" class="form-control"  readonly>
                                            </div>
                                       ...
                                       <a href="TeacherServlet?action=TeacherList" class="btn btn-info   mt-3">返回</a>
	...
	$("#save").click(function() {
		//swal("删除失败", "", "success")
		 $.ajax({
			cache:true,
			type : "post",
			url : "TeacherServlet?action=updateTeacher",
