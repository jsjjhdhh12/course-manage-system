					...
					<div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">班级信息列表</h4>
                            </div>
                                <div class="card-header">
                                    <form action="ClassesServlet?action=ClassesList"  method="post"  class="d-flex align-items-center">
                                        <div class="mb-2 mx-sm-3">
                                            <input type="text" name="key" value="${key }" class="form-control" placeholder="班级名称">
                                        </div>
    ...
    function del(id){
    	if(confirm("确定要删除吗？")){
    		$.ajax({
    			cache:true,
    			type : "post",
    			url : "ClassesServlet?action=deleteClasses",
    			 data :{"id":id},
    			async:false,
    			success : function(e) {
    				if (e == "yes") {
